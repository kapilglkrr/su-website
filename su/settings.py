...
DATABASE_PATH = os.path.join(PROJECT_PATH, 'su.db')
...
DATABASES = {
    'default': {
        ...
        'NAME': 'su',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'h293at#k!fcbo270yyo3_8_v04&amp;!lvcy#y@8p6(#i%0*j=4ek9'
